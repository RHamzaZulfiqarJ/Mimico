    ...
    >
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-5">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="text-4xl font-bold text-white">Instagram Threads</h1>
            <p className="text-gray-400 mt-1">
              Manage Threads accounts and Threads-specific scheduled posts.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div className="xl:col-span-1 glass rounded-2xl border border-white/5 overflow-hidden">
          <SectionHeader
            ...
            text="Only Threads accounts are shown here."
          />
          ...
          <div className="divide-y divide-white/5">
            {accounts.length === 0 ? (
              <EmptyState
                ...
                text="Connect Threads to publish or schedule posts."
              />
            ) : (
      ...
      <div className="glass rounded-2xl border border-white/5 p-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-bold text-white">Threads page rule</h3>
            <p className="text-sm text-gray-400 mt-1">
              This page only manages Threads accounts and Threads posts. Twitter, Mastodon and WhatsApp stay separate.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="p-8 text-center">
      <div className="w-12 h-12 mx-auto rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-3">
        <SiThreads className="w-5 h-5 text-gray-500" />
      </div>
