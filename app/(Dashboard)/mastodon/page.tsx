    ...
    >
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-5">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
            <SiMastodon className="w-7 h-7 text-purple-300" />
          </div>

          <div>
            <p className="text-sm text-purple-300 font-semibold mb-1">Platform Page</p>
            <h1 className="text-4xl font-bold text-white">Mastodon</h1>
            <p className="text-gray-400 mt-1">
              Manage Mastodon accounts and Mastodon-specific scheduled posts.
            </p>
          </div>
        </div>
                ...
                <div key={account.id} className="p-5 space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="w-11 h-11 rounded-2xl bg-purple-500/10 border border-purple-500/20 flex items-center justify-center">
                      <SiMastodon className="w-5 h-5 text-purple-300" />
                    </div>
      ...
      <div className="glass rounded-2xl border border-white/5 p-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-bold text-white">Mastodon page rule</h3>
            <p className="text-sm text-gray-400 mt-1">
              This page only manages Mastodon accounts and Mastodon posts. Twitter and WhatsApp stay separate.
            </p>
          </div>
        </div>
      </div>
