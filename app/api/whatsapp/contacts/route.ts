...
export async function GET(req: Request) {
  try {
    ...
    const result = await listWhatsAppContacts(userId, socialAccountId, {
...
export async function POST(req: Request) {
  try {
    ...
    if (Array.isArray(body.contacts)) {
      const result = await importWhatsAppContacts(userId, body);
    ...
    const contact = await createWhatsAppContact(userId, body);
